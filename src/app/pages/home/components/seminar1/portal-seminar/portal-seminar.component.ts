...
@Component({
  ...
  templateUrl: './portal-seminar.component.html',
  styleUrl: './portal-seminar.component.scss'
})
export class PortalSeminarComponent implements OnInit, OnDestroy, AfterViewInit {
