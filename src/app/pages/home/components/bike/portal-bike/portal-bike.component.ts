...
@Component({
  ...
  templateUrl: './portal-bike.component.html',
  styleUrl: './portal-bike.component.scss'
})
export class PortalBikeComponent implements OnInit, AfterViewInit, OnDestroy{
